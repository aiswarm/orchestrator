/**
 * Identifier-shape helpers.
 *
 * Plugin types, skill names, context-provider names, and other registry keys
 * have to satisfy specific identifier shapes (lower-kebab-case for
 ...
 * identifier-shape concerns (namespace parsing for `driver:tool` strings,
 * reserved-word lists, length limits, reverse-DNS plugin IDs) belong here too.
 *
